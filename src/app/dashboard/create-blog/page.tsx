...
import { generateBlogTemplate, type GenerateBlogTemplateOutput } from '@/ai/flows/generate-blog-template';
...
const formSchema = z.object({
  blogTopic: z.string().min(3, { message: 'Blog topic must be at least 3 characters long.' }),
});
...
export default function CreateBlogPage() {
  ...
  const [result, setResult] = useState<GenerateBlogTemplateOutput | null>(null);
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    setEditedHtml('');
    try {
      const response = await generateBlogTemplate({ 
        blogTopic: values.blogTopic,
      ...
      toast({
        ...
        description: "There was a problem generating the blog.",
      })
    } finally {
      setLoading(false);
    }
  ...
  async function handleSaveBlog() {
    ...
    try {
      ...
      const storagePath = `blogs/${user.uid}/${blogId}.html`;
      ...
      toast({
        title: "Blog Saved!",
        description: "Your new blog has been saved to the cloud.",
      });
      ...
      router.push('/dashboard/blogs');
        ...
        toast({
          ...
          description: "There was a problem saving your blog to the cloud.",
        });
    } finally {
      setSaving(false);
    }
    ...
    <div className="grid gap-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Describe your blog topic, and our AI will generate a complete, content-rich blog to get you started.</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>What is your blog about?</FormLabel>
                    <FormControl>
                      <Input placeholder="e.g., The future of AI, sustainable travel, home cooking recipes..." {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div className="space-y-4">
                ...
                <CardDescription>Select images from your media library to give the AI context for your blog design.</CardDescription>
                {loadingMedia ? (
      ...
      {loading && (
        <div className="flex items-center justify-center p-8">
          ...
          <p className="ml-4 text-muted-foreground">Generating your blog, this may take a moment...</p>
        </div>
      )}
          ...
          <Card>
            <CardHeader className="flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Here's what our AI came up with. You can refine it with the AI assistant below.</CardDescription>
              </div>
              <Button onClick={handleSaveBlog} disabled={saving || isRefining}>
                {saving ? (
           ...
           <Card>
                <CardHeader>
                    <CardTitle>Refine Your Blog</CardTitle>
                    <CardDescription>The AI has suggested some improvements. Select the ones you want to apply, or write your own custom request.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <form onSubmit={(e) => { e.preventDefault(); handleRefinementRequest(customRequest); }}>
                    <div className="space-y-2">
                      ...
                      <Textarea
                          id="customRequest"
                          placeholder="e.g., Make the header bigger and the footer blue"
                          value={customRequest}
